    ...
    <div  class="bg-stone-900 w-full flex-1 ">
        <div  class="container lg:w-3/4 mx-auto justify-center flex-wrap overflow-hidden mb-10">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 auto-rows-fr gap-8  p-4">
                <div v-for="(album, albumId) in albums" class="flex flex-col items-center justify-end group hover:cursor-pointer ">
                    <div class="flex-grow flex items-center">
                        <h3 class="text-center text-2xl  text-white font-bungee-hairline p-3 hover:text-orange-300"><router-link :to="{ name: 'album', params: {'id' : albumId}}">{{ album.title }}</router-link></h3>
                    </div>

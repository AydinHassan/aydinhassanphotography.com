<template>
    ...
    <div class="container lg:w-3/4 mx-auto flex flex-col mt-6 mb-10">
        <div class="flex items-start sm:items-center flex-col sm:flex-row">
            ...
            <h1 class="text-white text-left sm:text-center text-3xl md:text-4xl p-4 font-bungee-hairline font-bold">Countries</h1>
        </div>
        <p class="mx-4 text-white font-bungee-hairline text-sm sm:text-base" >A little slice of our majestic planet from my travels through Europe and Asia, hitchhiking through the Alps to Morocco, overlanding through Turkey and the Caucasus to Central Asia, long distance mountain treks and plenty of other adventures inbetween.</p>
        <album-list route="countries" album-key="countries"/>
    </div>
</template>